...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (request.getRequestURI().startsWith("/api")
                ...
                || request.getRequestURI().startsWith("/candidature")) {
        ...
        // 4- Si le token est valide : connecter l'utilisateur en prenant en considerant
        // son role
        Authentication authentication = new UsernamePasswordAuthenticationToken(userConnect, null,
                userConnect.getAuthorities());
